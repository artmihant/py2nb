...
def show_help():
    ...
    print("🔄 py2nb - Конвертер Python ↔ Jupyter Notebook")
    print("=" * 50)
    print()
    print("📖 ОПИСАНИЕ:")
    ...
    print("    python py2nb.py input.py                    # → input.ipynb")
    print("    python py2nb.py input.ipynb                 # → input.py")
    print("    python py2nb.py input.py output.ipynb       # указанное имя")
    print("    python py2nb.py input.py output             # → output.ipynb")
    print()
    print("  Многофайловое слияние:")
    print("    python py2nb.py file1.py file2.py merged.ipynb")
    print("    python py2nb.py nb1.ipynb nb2.ipynb merged.py")
    print()
    ...
    print()
    print("📚 ПРИМЕРЫ:")
    print("  python py2nb.py script.py")
    print("  python py2nb.py notebook.ipynb")
    print("  python py2nb.py --help")
    print()
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print()
        print("Использование:")
        print("  python py2nb.py input.py [output.ipynb]    # py → ipynb")
        print("  python py2nb.py input.ipynb [output.py]    # ipynb → py")
        print("  python py2nb.py input1.py input2.py output.ipynb  # многофайловое слияние")
        print("  python py2nb.py --help                     # подробная справка")
        print()
    ...
    if len(sys.argv) == 2:
        ...
        if second_path.suffix in ['.py', '.ipynb'] and first_path.suffix == second_path.suffix:
            ...
            print("Использование: python -m py2nb input1.py input2.py output.ipynb")
            sys.exit(1)
        else:
